...
export const TILE_DEF = {
  ...
  [T.MOUNTAIN]:       { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060' },
  [T.MOUNTAIN_STONE]: { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060' },
  [T.MOUNTAIN_DEEP]:  { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060' },
  [T.ORE_COAL]:       { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060', ore: 'coal', yield: 8 },
  [T.ORE_IRON]:       { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060', ore: 'iron', yield: 5 },
  [T.ORE_GOLD]:       { walkable: false, mineable: true,  moveCost: 0,    colour: '#7a7060', ore: 'gold', yield: 2 },
